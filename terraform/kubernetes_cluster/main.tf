resource "google_container_cluster" "preprodcluster" {
  name     = "preprodcluster"
  location = var.region
...
resource "google_container_node_pool" "preprodcluster_linux_node_pool" {
  name           = "${google_container_cluster.preprodcluster.name}--linux-node-pool"
  location       = google_container_cluster.preprodcluster.location
  node_locations = var.node_zones
  cluster        = google_container_cluster.preprodcluster.name
  node_count     = 10
